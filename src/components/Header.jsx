...
export const Header = ({ whatsapp, negocioCiudad, logo }) => {
    ...
    return (
        <div className={styles.header}>
            <div className={styles.logo} style={{ backgroundImage: `url(${logoDisplay})` }}>
            </div>
            ...
            <form className="search" onSubmit={handleSearch} style={{ display: 'flex', gap: '0.5rem', flex: 1, maxWidth: '400px' }}>
                ...
                />
                <button type="submit" style={{ width: '34px', height: '34px', borderRadius: 'var(--radius-full)', background: 'var(--primary)', color: 'white', border: 'none', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
